...
import { DoorsOverlay } from 'components/overlay/doors-overlay';
import { LiftsOverlay } from 'components/overlay/lifts-overlay';
// import { createMicroApp } from './micro-app';
import { RmfAppContext } from 'components/rmf-app';
import { RobotData, RobotsOverlay } from 'components/overlay/robots-overlay';
import { TrajectoriesOverlay, TrajectoryData } from 'components/overlay/trajectories-overlay';
import { WaypointsOverlay } from 'components/overlay/waypoints-overlay';
import { WorkcellData, WorkcellsOverlay } from 'components/overlay/workcells-overlay';
...
export const MapApp = () => {
  ...
  React.useEffect(() => {
    const sub = AppEvents.robotSelect.subscribe((data) => {
      ...
      if (!bounds) {
        console.warn(`Map: Fail to zoom to robot ${robotId} (missing bounds, map was not loaded?)`);
        return;
      }
