...
const Palette = (mode: ThemeMode, presetColor: PresetColor) => {
  ...
  return createTheme({
    palette: {
      ...
      text: {
        primary:
          mode === ThemeMode.DARK ? alpha(paletteColor.grey[900]!, 0.87) : paletteColor.grey[700],
        secondary:
          mode === ThemeMode.DARK ? alpha(paletteColor.grey[900]!, 0.45) : paletteColor.grey[500],
        disabled:
          mode === ThemeMode.DARK ? alpha(paletteColor.grey[900]!, 0.1) : paletteColor.grey[400],
      },
      action: {
