export default {
  ...
  paths: {
    ...
    '/stations/{station_name}/state': {
      get: {
        tags: ['Stations'],
        summary: 'Get Station State',
        description: 'Available in socket.io',
        operationId: 'get_station_state_stations__station_name__state_get',
        security: [{ OpenIdConnect: [] }],
        parameters: [
          {
            name: 'station_name',
            in: 'path',
            required: true,
            schema: { type: 'string', title: 'Station Name' },
          },
        ],
        responses: {
          '200': {
            description: 'Successful Response',
            content: {
              'application/json': { schema: { $ref: '#/components/schemas/StationState' } },
            },
          },
          '422': {
            description: 'Validation Error',
    ...
    '/stations/{station_name}/request': {
      post: {
        tags: ['Stations'],
        summary: 'Post Station Request',
        operationId: 'post_station_request_stations__station_name__request_post',
        security: [{ OpenIdConnect: [] }],
        parameters: [
          {
            name: 'station_name',
      ...
      StationRequest: {
        properties: {
          station_type: {
            ...
            title: 'Station Type',
            description:
              'https://github.com/tannhat22/machine_fleet/blob/rmf-jazzy/machine_fleet_msgs/msg/StationRequest.msg',
          },
          station_mode: {
            type: 'integer',
            title: 'Station Mode',
        ...
        type: 'object',
        required: ['station_type', 'station_mode'],
        title: 'StationRequest',
      },
      StationState: {
        properties: {
          station_name: { type: 'string', title: 'Station Name' },
          mode: { type: 'integer', maximum: 255.0, minimum: 0.0, title: 'Mode' },
        },
        type: 'object',
        required: ['station_name', 'mode'],
        title: 'StationState',
      },
      'Status-Input': {
        type: 'string',
