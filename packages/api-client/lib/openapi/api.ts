...
export const StationsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getStationStateStationsStationNameStateGet: async (
      stationName: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'stationName' is not null or undefined
      assertParamExists('getStationStateStationsStationNameStateGet', 'stationName', stationName);
      const localVarPath = `/stations/{station_name}/state`.replace(
        `{${'station_name'}}`,
        encodeURIComponent(String(stationName)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
     ...
     * @param {string} stationName
     * @param {StationRequest} stationRequest
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    postStationRequestStationsStationNameRequestPost: async (
      stationName: string,
      ...
      // verify required parameter 'stationName' is not null or undefined
      assertParamExists(
        'postStationRequestStationsStationNameRequestPost',
        'stationName',
        stationName,
      );
      // verify required parameter 'stationRequest' is not null or undefined
      assertParamExists(
        'postStationRequestStationsStationNameRequestPost',
        'stationRequest',
        stationRequest,
      );
      const localVarPath = `/stations/{station_name}/request`.replace(
        `{${'station_name'}}`,
        encodeURIComponent(String(stationName)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const StationsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getStationStateStationsStationNameStateGet(
      stationName: string,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StationState>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getStationStateStationsStationNameStateGet(
          stationName,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['StationsApi.getStationStateStationsStationNameStateGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async postStationRequestStationsStationNameRequestPost(
      stationName: string,
      stationRequest: StationRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postStationRequestStationsStationNameRequestPost(
          stationName,
          stationRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['StationsApi.postStationRequestStationsStationNameRequestPost']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const StationsApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getStationStateStationsStationNameStateGet(
      stationName: string,
      options?: any,
    ): AxiosPromise<StationState> {
      return localVarFp
        .getStationStateStationsStationNameStateGet(stationName, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    postStationRequestStationsStationNameRequestPost(
      ...
      return localVarFp
        .postStationRequestStationsStationNameRequestPost(stationName, stationRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class StationsApi extends BaseAPI {
   ...
   */
  public getStationStateStationsStationNameStateGet(
    stationName: string,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof StationsApi
   */
  public postStationRequestStationsStationNameRequestPost(
    stationName: string,
    stationRequest: StationRequest,
    options?: RawAxiosRequestConfig,
  ) {
